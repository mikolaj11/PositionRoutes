...
In this article we investigate the Robinson-Schensted-Knuth algorithm and consider the position of the box with a fixed number depending on the position of the number in the sequence. We present the limit shape and the proof of the uniform convergence in probability, when number of boxes goes to infinity.  
