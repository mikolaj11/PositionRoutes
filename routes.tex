...
$(x_1,y_1)<(x_2,y_2)$ only and only if $x_1<x_2$ and $y_1>y_2$. The relation $<$ retains the order of the points on the plane along the line $y=-x$. In addition, the function $G(x)$ is also monotonic with respect to the relation $<$ on the plane.
\end{theorem}
...
\end{matrix}
$$
From Theorem \ref{thm:romthm} we have the relation $<$ on the plane. Then:
